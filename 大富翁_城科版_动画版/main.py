...
def main():
    ...
    pygame.display.set_caption("城科大富翁")
    ...
    chess = pygame.image.load("resource\\pic\\小骑士.png")
    chess_com = pygame.image.load("resource\\pic\\王格林.png")
    bigdice_image = pygame.image.load("resource\\pic\\骰子.png").convert_alpha()#骰子
    dice_1 = pygame.image.load("resource\\pic\\骰子1.png")#骰子
    dice_2 = pygame.image.load("resource\\pic\\骰子2.png")#骰子
    dice_3 = pygame.image.load("resource\\pic\\骰子3.png")#骰子
    dice_4 = pygame.image.load("resource\\pic\\骰子4.png")#骰子
    dice_5 = pygame.image.load("resource\\pic\\骰子5.png")#骰子
    dice_6 = pygame.image.load("resource\\pic\\骰子6.png")#骰子
    ...
    bgm = pygame.mixer.music.load("resource\\sound\\bgm.wav")
    ...
    yes_rect.left, yes_rect.top = 845, 36
    no_rect = no.get_rect()
    no_rect.left, no_rect.top = 900, 36
    button_rect = StartGameButton.get_rect()
    button_rect.left, button_rect.top = (500,300)
    ...
    # fountain = Building('报告厅', 2000, 400, [3, 4])
    # path = Building('小道', 800, 160, [5])
    # library = Building('求是楼', 2000, 400, [6, 7])
    ...
    # 初始化建筑物数据
    gate1 = Building('报告厅', 1000, 200, [1])
    gate2=Building('小道', 400, 100, [2])
    fountain1 = Building('宿舍楼', 800, 160, [3])
    fountain2 = Building('宿舍楼', 800, 160, [4])
    fountain3 = Building('宿舍楼', 800, 160, [5])
    fountain4 = Building('宿舍楼', 800, 160, [6])
    fountain5 = Building('宿舍楼', 800, 160, [7])
    # path = Building(' ', 800, 160, [5])
    # library = Building('求是楼', 2000, 400, [6, 7])
    kongdi1 = Building('空地', 0, 0, [8])
    classroomTen1 = Building('食堂', 1000, 200, [9])
    classroomTen2=Building('体育中心', 1000, 200, [10])
    classroomNine1 = Building('游泳池', 500, 120, [11])
    classroomNine2 = Building('高级会所', 2000, 400, [12])
    resOne = Building('左操场', 800, 160, [13])
    resTwo = Building('右操场', 800, 160, [14])
    resThree = Building('篮球场', 800, 160, [15])
    kongdi2 = Building('空地', 0, 0, [0])

    buildings = [gate1,gate2, fountain1, fountain2,fountain3,fountain4,fountain5,classroomTen1, classroomTen2, classroomNine1, \
                 classroomNine2, resOne, resThree, resTwo,kongdi1, kongdi2]

    # 坐标数据 同时处理坐标数据 使之合适
    MapXYvalue = [(1129, 481), (1023, 617),(780, 686), (584, 694), (325, 687), \
                  (399, 554), (447, 409), (635, 560),(872, 553),(773, 474), \
                  (639, 403), (545, 375), (617, 140), (758, 286),(899, 357), \
                  (1003, 447)
                  ]
    ...
    MapMessageBoxPosition = (789, 90)                   #文字位置
    YesNoMessageBoxPosition = [(845, 36), (900, 36)]    #是否购买房产按钮
    StartGameButtonPosition = (500,300)                 #开始按钮位置
    TurnOvwrButtonPosition = (1035, 613)                #机械人按钮
#(1003, 30)
    # 调整位置
    for i in range(0, 16):
